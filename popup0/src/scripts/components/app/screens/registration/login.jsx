  ...
  if(login !==''  && login !== ' ' && password !== ''  && password !== ' '){
    ...
    axios({
      ...
      data: {
        ...
        {
          this.setState({alertText:'User is not registered',showAlert:true,loading:false})
        }
        })
    }
    else
    {
      this.setState({ alertText:'Fill all inputs to continue',showAlert:true,loading:false})
    }
